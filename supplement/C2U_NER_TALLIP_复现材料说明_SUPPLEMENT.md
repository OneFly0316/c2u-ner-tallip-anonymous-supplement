...
为便于匿名评审和后续归档，本文将复现材料划分为正文、数据说明、脚本、结果、图件、人工复核和受限数据六类。匿名评审阶段提供不暴露作者身份且不违反源端许可的材料；论文接收或预印本发布后，再补充归档 DOI、最终许可证和可公开数据文件。当前本地匿名补充材料目录为 `submission/C2U_NER_TALLIP_anon_supplement/`，已推送至 https://github.com/OneFly0316/c2u-ner-tallip-anonymous-supplement。由于该仓库当前位于作者账号下，正式双盲投稿前应转移到匿名账号或匿名组织。
